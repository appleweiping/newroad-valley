...
const ROADMAP: { zh: string; en: string; date: string; done: boolean; descZh: string; descEn: string }[] = [
  ...
  { zh: "v11 · 日历与邮局（下一个大版本）", en: "v11 · Calendar & Mail (next)", date: "排队中", done: false, descZh: "28 日季历标节日与发布日；家门口信箱收 agent 来信（真实信号成信）；每季第 4 天小节日；Haiku 每日运势影响钓鱼。", descEn: "A 28-day season calendar; a mailbox of real agent letters; little seasonal festivals; Haiku's daily fortune sways the fishing." },
];
